...
import { ActionCard, ActionCardProps, FeedbackRoute } from "@patronage-web/shared";
...
export default {
  ...
  args: {
    button: { variant: "contained", text: "Lorem ipsum", navigateTo: FeedbackRoute.AddPresentation },
    description:
